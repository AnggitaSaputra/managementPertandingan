...
@section('content')
    <table id="table" class="w-full display responsive no-wrap min-w-full">
        <thead>
            <tr>
                <th>#</th>
                <th>Nama</th>
        ...
        if (!$.fn.DataTable.isDataTable('#table')) {
            $('#table').DataTable({
                ...
                columnDefs: [
                    ...
                    { responsivePriority: 3, targets: 2 }, // Jenis Kelamin
                    { responsivePriority: 4, targets: 3 }, // Berat Badan
                    { responsivePriority: 5, targets: 4 }, // Foto Diri
                    { responsivePriority: 6, targets: 5 }, // Foto KTP
                    { responsivePriority: 7, targets: 6 }, // Ijazah Karate
